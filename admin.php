...
<div id="userinfo">
    ...
    <?php
        ...
        echo "<a href='AlterUserManager.php?user_id=$id' style='float: right;margin-right: 100px;  position: absolute;color:#333;background-color: rgb(211, 207, 207);'>修改个人信息</a><br>";
        ?>
    <?php
